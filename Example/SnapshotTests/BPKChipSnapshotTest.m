...
- (void)configureParentView:(UIView *)parentView forChip:(BPKChip *)chip {
    ...
    [parentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-16-[chip]-16-|" options:0 metrics:nil views:@{@"chip": chip}]];
    [parentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-16-[chip]-16-|" options:0 metrics:nil views:@{@"chip": chip}]];
